...
//transliterate a cyrillic string into latin
function transliterate ($text) {
	foreach (array (
		/* lowercase */
		"а" => "a",	"б" => "b",	"в" => "v",	"г" => "g",	"д" => "d",	"ђ" => "dj",	"е" => "e",
		"ж" => "zh",	"з" => "z",	"и" => "i",	"ј" => "j",	"к" => "k",	"л" => "l",	"љ" => "lj",
		"м" => "m",	"н" => "n",	"њ" => "nj",	"о" => "o",	"п" => "p",	"р" => "r",	"с" => "s",
		"т" => "t",	"ć" => "cj",	"у" => "u",	"ф" => "f",	"х" => "h",	"ц" => "c",	"ч" => "ch",
		"џ" => "dzh",	"ш" => "sh",	"щ" => "sht",	"ш" => "sh",	"ю" => "yu",	"й" => "j",	"ъ" => "y",
		"ь" => "x",	"я" => "q",
		/* uppercase */
		"А" => "A",	"Б" => "B",	"В" => "V",	"Г" => "G",	"Д" => "D",	"Ђ" => "Dj",	"E" => "E",
		"Ж" => "Zh",	"З" => "Z",	"И" => "I",	"Ј" => "J",	"К" => "K",	"Л" => "L",	"Љ" => "Lj",
		"М" => "M",	"Н" => "N",	"Њ" => "Nj",	"О" => "O",	"П" => "P",	"Р" => "R",	"С" => "S",
		"Т" => "T",	"Ć" => "Cj",	"У" => "U",	"Ф" => "F",	"Х" => "H",	"Ц" => "C",	"Ч" => "Ch",
		"Џ" => "Dzh",	"Ш" => "Sh",	"Щ" => "Sht",	"Ш" => "Sh",	"Ю" => "Yu",	"Й" => "J",	"Ъ" => "Y",
		"Ь" => "X",	"Я" => "Q"
	) as $cyrillic => $latin) $text = str_replace ($cyrillic, $latin, $text);
